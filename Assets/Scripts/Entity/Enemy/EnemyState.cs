...
namespace Entity.Enemy
{
    ...
    {
        [Tooltip("0 - dead")] [SerializeField] [Range(0, 100)]
        private int health;

        [Tooltip("Determines how many health points are restored per tick.")] [SerializeField]
        private AnimationCurve regenerationCurve;

        [Tooltip("Probability that the NPC regenerates when not in a fight or chasing.")] [SerializeField]
